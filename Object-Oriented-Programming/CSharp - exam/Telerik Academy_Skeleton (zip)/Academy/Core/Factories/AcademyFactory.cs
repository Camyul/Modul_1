...
namespace Academy.Core.Factories
{
    public class AcademyFactory : IAcademyFactory
    {
        ...
        public IStudent CreateStudent(string username, string track)
        {
            ...
            Track trackNum = (Track)Enum.Parse(typeof(Track), track);
            return new Student(username, trackNum);
        }
        ...
        public ITrainer CreateTrainer(string username, string technologies)
        {
            ...
            IList<string> tech = technologies.Split(',');
            return new Trainer(username, tech);
        }
        ...
        public ICourse CreateCourse(string name, string lecturesPerWeek, string startingDate)
        {
            ...
            int lectures = int.Parse(lecturesPerWeek);
            DateTime startDate = DateTime.Parse(startingDate);
            return new Course( name, lectures, startDate);
        }
