namespace Student_groups
{
    ...
    public class StudentGroups
    {
        static void Main()
        {
            ...
            listOfStudent.Add(new Student("Ivan", "Penev", "0220114565", "02501560", "test1@abv.bg", 3)); //Add Student
            listOfStudent.Add(new Student("Genka", "Veleva", "0120126954", "0878945225", "test2@mail.bg", 2));
            listOfStudent.Add(new Student("Mitko", "Zanev", "1220063245", "056201205", "test3@abv.bg", 2));
            ...
            listOfStudent.Add(new Student("Tanya", "Koleva", "0720102235", "064205322", "test6@mail.ru", 3));
